  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between">
        ...
        <button
          type="submit"
          className={`w-1/3 self-end h-12 bg-coral border-2 border-white/40 hover:bg-coral/80 active:bg-coral/60 transition-colors text-black font-bold ${sendStatus === "sending"
