  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-4 w-3/4 mx-auto">
        <div className="text-left text-md relative">
          <GradientBg bgcolor="bg-[#253956]" />
        ...
        <div className="text-left text-md relative">
          ...
          <div className="flex flex-col gap-4 border-2 text-white border-white border-dashed relative z-10 p-4 h-full hover:cursor-default">
            ...
            <ul className="text-pretty list-disc list-inside">
              ...
              <li>improve my dexterity w/ vim (btw) motions and the editor as a whole.
                i've been following <a href="">this excellent lazyvim course</a> for the past few weeks!</li>
        ...
        <div className="text-left text-md relative">
          ...
          <div className="flex flex-col gap-1 border-2 text-white border-white border-dashed relative z-10 p-4 h-full hover:cursor-default">
            <p>
              ...
              i became interested after attending a
        ...
        <div className="text-left text-md relative">
          ...
          <div className="text-left col-span-2 text-md relative">
            <GradientBg bgcolor="bg-[#253956]" />
            <div className="flex flex-col gap-1 border-2 text-white border-white border-dashed relative z-10 p-4 h-full hover:cursor-default">
              <p>
                abababba baba babababababa babbaduwdbauw buawbdauwoid  abwi awbudibabiwubd ibuwad
              </p>
            </div>
          </div>
        </div>
